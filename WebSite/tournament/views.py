...
from teams.models import Teams_Tournaments
...
class IndexView(generic.ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context.update({
            'tournament_started': Tournaments.objects.filter(tournament_start_date__lte = datetime.date.today()).filter(tournament_end_date__gte = datetime.date.today())[:9],
